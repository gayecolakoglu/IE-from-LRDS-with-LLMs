...
11. Types of recipients (Give number of organizations in each group)
    ...
    Educational institutions (1 student)
    Civic groups
    Other (specify) Import/export
...
Date of report: Dec. 1, 1992 (Nov. Rpt.)

Name and title: James Lin, manager
