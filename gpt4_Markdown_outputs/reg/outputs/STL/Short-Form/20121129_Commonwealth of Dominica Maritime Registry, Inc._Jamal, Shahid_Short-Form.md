...
3. Residence Address(es): 47 17th Street
4. Business Address(es): PO BOX 8579, Dammam 31492, Saudi Arabia
5. Year of Birth: 5th October 2012
   Nationality: Pakistani
   Present Citizenship: Pakistani
6. If present citizenship was not acquired by birth, indicate when, and how acquired: N/A
7. Occupation: Marine Surveyor
...
11. Describe separately and in detail all services which you will render to the foreign principal(s) listed in Item 10 either directly, or through the primary registrant listed in Item 8, and the date(s) of such services. (If space is insufficient, a full insert page must be used.)
    Inspection and/or survey services for Dominica flagged vessels.
```

```markdown
Received by NSD/FARA Registration Unit: 11/29/2012 9:43:59 AM
...
- Date of signature: November 13, 2012
- Signature: /s/ Shahid Jamal
- eSigned: 
