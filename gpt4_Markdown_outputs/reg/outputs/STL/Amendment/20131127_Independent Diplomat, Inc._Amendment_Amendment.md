```markdown
Received by NSD/FARA Registration Unit: 11/27/2013 2:49:41 PM
...
1. Name of Registrant: Independent Diplomat

2. Registration No.: 5860
...
4. If this amendment requires the filing of a document or documents, please list:
   This amendment is to file renewed contracts pursuant to Exhibit B for the following foreign principals: The Government of the Republic of South Sudan.
...
5. Each item checked above must be explained below in full detail together with, where appropriate, specific reference to and identity of the item in the registration statement to which it pertains. (If space is insufficient, a full insert page must be used.)
   This amendment is to update Independent Diplomat's existing foreign principal files with current contracts, as requested in Exhibit B.
...
(Date of signature): November 27, 2013

(Print or type name under each signature or provide electronic signature¹): /s/ Carne William Ross
