...
5. Each item checked above must be explained below in full detail together with, where appropriate, specific reference to and identity of the item in the registration statement to which it pertains. (If space is insufficient, a full insert page must be used.)
   - The registrant has a new signed agreement with the Taipei Economic and Cultural Representative Office in the United States
```

```markdown
Received by NSD/FARA Registration Unit: 02/24/2017 12:31:22 PM
...
(Date of signature): February 24, 2017

(Print or type name under each signature or provide electronic signature*): /s/ Adam Biegel
