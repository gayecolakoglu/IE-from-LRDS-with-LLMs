```markdown
Received by NSD/FARA Registration Unit: 06/04/2012 10:04:24 AM
...
5. Each item checked above must be explained below in full detail together with, where appropriate, specific reference to and identity of the item in the registration statement to which it pertains. (If space is insufficient, a full insert page must be used.)
    Please terminate the short form registration of Kristin D. Wells relating to her work for our client, Interim Transitional National Council of Libya. Ms. Wells no longer performs work on behalf of this client.
