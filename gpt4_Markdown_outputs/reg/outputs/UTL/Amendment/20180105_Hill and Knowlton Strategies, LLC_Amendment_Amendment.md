...
Contract between Hill and Knowlton, Strategies and Ministry of Economy and Planning, Kingdom of Saudi Arabia
...
Registrant indicated on initial filing that relationship with foreign principal was pursuant to a written contract that had not yet been finalized. Written contract was finalized in Arabic. We now have the translated version of the contract and it is attached.
```

```markdown
Received by NSD/FARA Registration Unit: 01/05/2018 1:48:51 PM
...
(Date of signature): January 05, 2018

(Print or type name under each signature or provide electronic signature*): /s/ Meredith Marks, Global General Couns
